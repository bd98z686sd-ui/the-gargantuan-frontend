...
export default function Admin(){
  ...
  const [showUploader, setShowUploader] = useState(!!token);

  return (
    <div className="min-h-screen bg-[#f6f6f6] text-[#121212]">
      <header className="bg-[#052962] text-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-4 border-b-4 border-[#c70000]">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6 space-y-6">
          ...
          <div className="bg-white border border-[#dcdcdc] rounded-lg p-4">
            ...
            <div className="flex gap-3">
              ...
              <button className="px-4 py-2 bg-[#052962] text-white rounded text-sm font-semibold"
                onClick={()=> setShowUploader(true)}>Continue</button>
            </div>
        ...
        {showUploader && (
          <>
            <Uploader onDone={()=>toast.show('Published successfully.','ok')} token={token} toast={toast} />
